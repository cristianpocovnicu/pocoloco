...
- **„Harta amintirilor" — construită și retrasă în aceeași săptămână**
  ...
  vizitate" și le punea pe hartă. *Retrasă pe 12 august*, după primul test
  pe poze reale: **niciuna n-avea GPS**. Sincronizările, editările și
  transferurile curăță EXIF-ul mult mai des decât estimasem, iar un feature
  de descoperire care întoarce o hartă goală e mai rău decât lipsa lui.
  Motivul complet și ce s-ar face altfel, în
  [`docs/backlog-feedback.md`](./docs/backlog-feedback.md) la „NU".
  *Ce rămâne ca lecție:* premisa („datele există deja în telefon") n-a fost
  verificată pe date reale înainte de construit. Verificarea costa o
  jumătate de oră.
