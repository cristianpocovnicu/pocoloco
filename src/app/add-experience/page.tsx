...
export default function AddExperiencePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!locationId) throw new Error('Nu am putut crea locația')
  ...
  const StarRating = ({ value, onChange, label, required }: { value: number, onChange: (v: number) => void, label: string, required?: boolean }) => (
    <div className="flex items-center justify-between py-3 border-b border-[rgba(0,0,0,0.06)] last:border-0">
      <div>
        ...
        {required && <div className="text-[11px] text-[#9B9B9B]">Obligatoriu</div>}
        {!required && <div className="text-[11px] text-[#9B9B9B]">Opțional</div>}
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#F8F7F5]">
      {/* Header */}
      <div className="bg-white border-b border-[rgba(0,0,0,0.08)] px-5 py-3.5 flex items-center justify-between sticky top-0 z-30 max-w-[520px] mx-auto">
      ...
      {error && (
        <div className="max-w-[520px] mx-auto px-5 pt-3">
      ...
      <div className="max-w-[520px] mx-auto px-5 pt-6 pb-24">
        ...
        {step === 0 && (
          <div>
            <div className="mb-6">
              ...
              <p className="text-[14px] text-[#6B6B6B]">Introdu numele locului pe care l-ai vizitat.</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-[rgba(0,0,0,0.08)] rounded-xl pl-10 pr-4 py-3 text-sm outline-none focus:border-[#E8440A] focus:bg-white transition-colors placeholder:text-[#9B9B9B]"
                  />
                </div>
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-[rgba(0,0,0,0.08)] rounded-xl px-4 py-3 text-sm outline-none focus:border-[#E8440A] focus:bg-white transition-colors placeholder:text-[#9B9B9B]"
                />
              </div>
            </div>
          </div>
        ...
        {step === 1 && (
          <div>
            <div className="mb-6">
              ...
              <p className="text-[14px] text-[#6B6B6B]">Până la 5 poze din vizita ta. Ajută alți călători!</p>
            </div>
        ...
        {step === 2 && (
          <div>
            <div className="mb-6">
              ...
              <p className="text-[14px] text-[#6B6B6B]">Evaluează experiența ta la acest loc.</p>
            </div>
        ...
        {step === 3 && (
          <div>
            <div className="mb-6">
              ...
              <p className="text-[14px] text-[#6B6B6B]">Ce ai trăit? Sfaturi practice, momente speciale, ce să evite alții.</p>
            </div>
            <textarea
              value={content}
              onChange={e => setContent(e.target.value)}
              rows={6}
              placeholder="Ex: Am ajuns dimineața devreme și practic n-am avut coadă. Castelul arată exact ca în filme — atmosfera medievală e autentică. Sfatul meu: rezervați biletele online..."
        ...
        {step === 4 && (
          <div>
            <div className="mb-6">
              ...
              <p className="text-[14px] text-[#6B6B6B]">Verifică detaliile și publică experiența ta.</p>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-[#E8440A] text-white font-outfit text-[15px] font-bold py-4 rounded-full flex items-center justify-center gap-2 disabled:opacity-70 transition-opacity"
            >
