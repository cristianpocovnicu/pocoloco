...
import { getLocationExperiences, type LocationExperience, type LocationPage } from '@/lib/seo'
...
/**
 * Conținutul paginii unui loc — randat pe server.
 *
...
export default async function LocationView({
  ...
  /** bannerul de moderare, randat de ruta care știe cine se uită */
